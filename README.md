...
Desarrollador **full stack** en formación, con base en administración de sistemas y un toque de ciberseguridad. Me gusta construir proyectos de principio a fin: desde la base de datos hasta la interfaz.
...
- 🐍 **Google IT Automation with Python** — Programa especializado (2024)
...
⭐ Échale un vistazo a mis repositorios y no dudes en escribirme si quieres colaborar.
